...
describe("DashboardStats", () => {
  ...
  it("renders statistics correctly", () => {
    ...
    const completionElement = screen
      .getByText("Match Completion")
      .closest("div")
      ?.querySelector(".text-2xl");
  ...
  it("applies correct styling to stat cards", () => {
    ...
    expect(
      screen.getByText("Total Play Dates").closest(".bg-gray-50")
    ).toBeInTheDocument();
    expect(
      screen.getByText("Upcoming").closest(".bg-blue-50")
    ).toBeInTheDocument();
    expect(
      screen.getByText("In Progress").closest(".bg-green-50")
    ).toBeInTheDocument();
    expect(
      screen.getByText("Match Completion").closest(".bg-purple-50")
    ).toBeInTheDocument();
  });
});
