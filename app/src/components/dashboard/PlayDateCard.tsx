...
import { formatPlayDateStatus, canEditPlayDate, type PlayDateWithStats } from '../../lib/supabase/playDates';
...
export function PlayDateCard({ playDate, onEdit }: PlayDateCardProps) {
  ...
  const canEdit = player && canEditPlayDate(playDate, player.id, player.project_owner || false);
  ...
  const matchProgress = playDate.match_count > 0
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-start justify-between">
          <div className="flex-1">
            <div className="flex items-center gap-2 mb-2">
              <span className={`inline-flex items-center gap-1 px-2 py-1 rounded-full text-xs font-medium ${statusConfig.color} ${statusConfig.pulseClass}`}>
        ...
        <div className="grid grid-cols-3 gap-3 text-center">
          <div className="space-y-1">
            ...
            <p className="text-sm font-medium text-gray-900">{playDate.player_count}</p>
          ...
          <div className="space-y-1">
            ...
            <p className="text-sm font-medium text-gray-900">{playDate.num_courts}</p>
