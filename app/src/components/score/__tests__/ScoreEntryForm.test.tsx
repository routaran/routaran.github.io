...
describe('ScoreEntryForm', () => {
  ...
  it('renders error messages', () => {
    ...
    expect(screen.getByText('• Winning team must reach 11 points')).toBeInTheDocument();
  });
  ...
  it('renders warning messages', () => {
    ...
    expect(screen.getByText('• Score of 25 is unusually high')).toBeInTheDocument();
  });
  ...
  it('shows permission denied message when cannot edit', () => {
    ...
    expect(screen.getByText('Only players in this match can update scores.')).toBeInTheDocument();
  });
