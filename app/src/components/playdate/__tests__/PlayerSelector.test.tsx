...
describe("PlayerSelector", () => {
  ...
  it("prevents duplicate names", async () => {
    ...
    await waitFor(() => {
      expect(
        screen.getByText("A player with this name already exists")
      ).toBeInTheDocument();
    });
  });
  ...
  it("prevents duplicate emails", async () => {
    ...
    await waitFor(() => {
      expect(
        screen.getByText("A player with this email already exists")
      ).toBeInTheDocument();
    });
  });
  ...
  it("respects maxPlayers prop", () => {
    ...
    render(
      <PlayerSelector {...defaultProps} players={maxPlayers} maxPlayers={16} />
    );
