...
describe('WinConditionSelector', () => {
  ...
  it('shows correct description for first-to-target', () => {
    ...
    expect(screen.getByText('First team to reach the target score wins')).toBeInTheDocument()
  })
  ...
  it('shows correct description for win-by-2', () => {
    ...
    expect(screen.getByText('Must reach target score and lead by at least 2 points')).toBeInTheDocument()
  })
  ...
  it('displays target score range help text', () => {
    ...
    expect(screen.getByText('Valid range: 5-21 points (default: 11)')).toBeInTheDocument()
  })
})