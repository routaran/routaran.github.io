...
export function PlayerStatsCard({
  ...
  const getPerformanceTier = (winPercentage: number) => {
    if (winPercentage >= 80)
      return { tier: "Elite", color: "bg-purple-100 text-purple-800" };
    if (winPercentage >= 70)
      return { tier: "Advanced", color: "bg-blue-100 text-blue-800" };
    if (winPercentage >= 60)
      return { tier: "Skilled", color: "bg-green-100 text-green-800" };
    if (winPercentage >= 50)
      return { tier: "Developing", color: "bg-yellow-100 text-yellow-800" };
                  ...
                  <div className="bg-gray-50 p-3 rounded-lg">
                    ...
                    <p
                      className={`text-lg font-semibold ${
                        currentStats.point_differential > 0
                          ? "text-green-600"
                          : currentStats.point_differential < 0
                            ? "text-red-600"
                            : "text-gray-900"
                    ...
                    >
                      {currentStats.point_differential > 0 ? "+" : ""}
                      {currentStats.point_differential}
                    </p>
                  </div>
                  <div className="bg-gray-50 p-3 rounded-lg">
                    <p className="text-xs text-gray-500">Points For</p>
                    <p className="text-lg font-semibold text-gray-900">
                      {currentStats.points_for}
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-sm font-medium text-gray-900">
                      {playerStats.averageWinPercentage}%
                    </span>
                  </div>
                  <Progress
                    value={playerStats.averageWinPercentage}
                    className="h-2"
                  />
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-sm font-medium text-gray-900">
                      {playerStats.consistencyRating}/100
                    </span>
                  </div>
                  <Progress
                    value={playerStats.consistencyRating}
                    className="h-2"
                  />
                </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
                ...
                <div className="flex items-center space-x-3 p-3 bg-gray-50 rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500">
                      {playerStats.currentWinningStreak} games
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-3 p-3 bg-gray-50 rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500">
                      +{playerStats.bestPointDifferential}
                    </p>
                  </div>
                </div>
              </div>
            ...
            {playerStats.bestPartnership && (
              <div className="p-4 bg-green-50 border border-green-200 rounded-lg">
                ...
                <p className="text-sm text-green-700">
                  {playerStats.bestPartnership.player1_name} &{" "}
                      ...
                      <div className="text-right">
                        ...
                        <p
                          className={`text-sm font-medium ${
                            partnership.point_differential > 0
                              ? "text-green-600"
                              : partnership.point_differential < 0
                                ? "text-red-600"
                                : "text-gray-900"
                        ...
                        >
                          {partnership.point_differential > 0 ? "+" : ""}
                          {partnership.point_differential}
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div key={index} className="p-3 bg-gray-50 rounded-lg">
                    <div className="flex items-center justify-between">
                      ...
                      <div className="text-right">
                        <Badge
                          variant={
                            trend.matchResult.win_percentage >= 60
                              ? "success"
                              : trend.matchResult.win_percentage >= 40
                                ? "warning"
                                : "error"
                          }
                          className="text-xs"
                        ...
                        <p className="text-xs text-gray-500 mt-1">
                          {trend.matchResult.point_differential > 0 ? "+" : ""}
                          {trend.matchResult.point_differential}
                        </p>
                      </div>
                    </div>
                  </div>
 ...
 */
export function MiniPlayerStatsCard(
  props: Omit<PlayerStatsCardProps, "compact">
) {
