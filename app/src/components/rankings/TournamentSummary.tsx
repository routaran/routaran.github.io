...
export function TournamentSummaryCard({
  ...
  const getCompletionBadge = (percentage: number) => {
    if (percentage === 100) return { variant: 'success' as const, label: 'Complete' }
    if (percentage >= 75) return { variant: 'warning' as const, label: 'Nearly Done' }
    if (percentage >= 50) return { variant: 'info' as const, label: 'In Progress' }
  ...
  return (
    <Card className={`p-6 ${className}`}>
      <div className="flex items-center justify-between mb-6">
        <div>
          <h2 className="text-xl font-bold text-gray-900">Tournament Summary</h2>
      ...
      <div className="space-y-6">
          ...
          <div className="bg-blue-50 p-4 rounded-lg">
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-lg font-semibold text-blue-900">{summary.total_players}</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-green-50 p-4 rounded-lg">
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-lg font-semibold text-green-900">{summary.total_matches}</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-orange-50 p-4 rounded-lg">
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-lg font-semibold text-orange-900">{summary.total_points_scored}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        {/* Score Statistics */}
        <div>
          <h3 className="text-sm font-medium text-gray-900 mb-3">Score Statistics</h3>
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
            <div className="p-3 bg-gray-50 rounded-lg">
              <div className="flex items-center justify-between">
                <span className="text-sm text-gray-600">Highest Score</span>
                <span className="text-lg font-semibold text-gray-900">{summary.highest_score}</span>
              </div>
            </div>
            ...
            <div className="p-3 bg-gray-50 rounded-lg">
              <div className="flex items-center justify-between">
                ...
                <span className="text-lg font-semibold text-gray-900">{summary.lowest_score}</span>
              </div>
            </div>
            ...
            <div className="p-3 bg-gray-50 rounded-lg">
              <div className="flex items-center justify-between">
                ...
                <span className="text-lg font-semibold text-gray-900">{summary.average_match_score}</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div>
          <h3 className="text-sm font-medium text-gray-900 mb-3">Tournament Highlights</h3>
            ...
            {summary.most_wins && (
              <div className="flex items-center justify-between p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
                <div className="flex items-center">
                  ...
                  <div>
                    <p className="text-sm font-medium text-yellow-800">Most Wins</p>
                    <p className="text-xs text-yellow-700">{summary.most_wins.player_name}</p>
                  </div>
                </div>
            ...
            {summary.best_point_differential && (
              <div className="flex items-center justify-between p-3 bg-green-50 border border-green-200 rounded-lg">
                <div className="flex items-center">
                  ...
                  <div>
                    <p className="text-sm font-medium text-green-800">Best Point Differential</p>
                    <p className="text-xs text-green-700">{summary.best_point_differential.player_name}</p>
                  </div>
                </div>
            ...
            {summary.completion_percentage === 100 && (
              <div className="flex items-center justify-between p-3 bg-blue-50 border border-blue-200 rounded-lg">
                <div className="flex items-center">
                  ...
                  <div>
                    <p className="text-sm font-medium text-blue-800">Tournament Complete!</p>
                    <p className="text-xs text-blue-700">All matches have been played</p>
                  </div>
                </div>
        ...
        {/* Tournament Status */}
        <div>
          <h3 className="text-sm font-medium text-gray-900 mb-3">Tournament Status</h3>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            <div className="p-4 border border-gray-200 rounded-lg">
              <div className="flex items-center justify-between mb-2">
                <span className="text-sm font-medium text-gray-900">Match Completion</span>
                <span className="text-sm text-gray-600">{summary.completion_percentage}%</span>
              </div>
            ...
            <div className="p-4 border border-gray-200 rounded-lg">
              <div className="flex items-center justify-between mb-2">
                <span className="text-sm font-medium text-gray-900">Remaining Matches</span>
                <span className="text-sm text-gray-600">
                  {summary.total_matches - summary.completed_matches}
                </span>
              </div>
              <Progress 
                value={((summary.total_matches - summary.completed_matches) / summary.total_matches) * 100} 
                className="h-2"
                variant="secondary"
              />
            </div>
        ...
        <div className="bg-gray-50 p-4 rounded-lg">
          ...
          <div className="grid grid-cols-2 gap-4 text-sm">
            <div>
              ...
              <p className="font-medium text-gray-900">{summary.total_partnerships}</p>
            </div>
            <div>
            ...
            {summary.completion_percentage > 0 && (
              <>
                <div>
                  ...
                  <p className="font-medium text-gray-900">{summary.completed_matches}</p>
                </div>
                <div>
                  <p className="text-gray-600">Total Points</p>
                  <p className="font-medium text-gray-900">{summary.total_points_scored}</p>
                </div>
              </>
            )}
          </div>
  ...
  return (
    <Card className={`p-4 ${className}`}>
      <div className="flex items-center justify-between mb-4">
        ...
        <Badge variant={summary.completion_percentage === 100 ? 'success' : 'info'}>
        ...
        {summary.most_wins && (
          <div className="pt-2 border-t border-gray-200">
            ...
            <p className="text-sm font-medium text-gray-900">
              {summary.most_wins.player_name} ({summary.most_wins.games_won} wins)
            </p>
          </div>
        )}
      </div>
