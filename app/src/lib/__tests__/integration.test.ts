...
describe('Logging and Monitoring Integration', () => {
  ...
  it('should handle sync timing operations', () => {
    ...
    const result = logger.timeSync('sync_operation', mockFn, { component: 'integration-test' });
  ...
  it('should handle async timing operations', async () => {
    ...
    const result = await logger.time('async_operation', mockFn, { component: 'integration-test' });
  ...
  it('should handle monitoring operations', () => {
    ...
    expect(monitor.updateConnectionStatus).toHaveBeenCalledWith('connected', { component: 'integration-test' });
    expect(monitor.recordLatency).toHaveBeenCalledWith(50, { component: 'integration-test' });
  ...
  it('should handle monitoring callbacks', () => {
    ...
    vi.mocked(monitor.onConnectionStatusChange).mockReturnValue(mockUnsubscribe);
  ...
  it('should integrate logging and monitoring together', async () => {
    ...
    monitor.updateConnectionStatus('connecting', { component: 'integration-test' });
    
    const result = logger.timeSync('operation', mockOperation, { component: 'integration-test' });
    
    monitor.updateConnectionStatus('connected', { component: 'integration-test' });
    logger.info('Operation completed', { result, component: 'integration-test' });
