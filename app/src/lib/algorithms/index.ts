...
import { generatePartnerships, type Player, type Partnership } from './partnerships';
import { generateRoundRobinSchedule, type Round, type Match } from './scheduling';
import { assignCourts, optimizeCourtAssignments, type Court } from './courtAssignment';
...
export function generateTournament(
  ...
  const validation = validateTournament(players, partnerships, rounds, courts.length);
