...
export function RankingsPage() {
  ...
  const [activeTab, setActiveTab] = useState<
    "rankings" | "statistics" | "trends" | "summary"
  >("rankings");
  ...
  const selectedPlayer = selectedPlayerId
    ? rankings.find((r) => r.player_id === selectedPlayerId)
    : null;
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="flex items-center justify-between mb-8">
        ...
        <div className="flex items-center space-x-4">
          ...
          >
            <ArrowPathIcon
              className={`w-4 h-4 mr-2 ${rankingsRefreshing ? "animate-spin" : ""}`}
            />
            Refresh
          </Button>
        </div>
      ...
      {!progressLoading && progress && (
        <Card className="p-4 mb-6 bg-blue-50 border-blue-200">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-xs text-blue-700">
                  {progress.completedMatches} of {progress.totalMatches} matches
                  completed
                </p>
              </div>
            </div>
            ...
            <Badge
              variant={
                progress.completionPercentage === 100 ? "success" : "info"
              }
            >
              ...
              {selectedPlayer && playerStats ? (
                ...
                <Card className="p-8 text-center">
                  ...
                  <p className="text-gray-500 mb-4">
                    Click on a player in the rankings table to view their
                    detailed statistics
                  </p>
                  <Button
            ...
            <div className="space-y-6">
              {selectedPlayer && playerStats ? (
                ...
                <Card className="p-8 text-center">
                  ...
                  <p className="text-gray-500 mb-4">
                    Select a player to view their performance trends and
                    historical data
                  </p>
                  <Button
                    onClick={() => handleTabChange("rankings")}
              ...
              {tournamentSummary ? (
                ...
                <Card className="p-8 text-center">
                  ...
                  <p className="text-gray-500">
                    Tournament summary will be available once matches are
                    completed
                  </p>
                </Card>
              )}
